    ...
    return (
        <div className={styles.AccessibilitySpecifications}>
            ...
            <section>
                ...
                >
                    Contrast (Minimum) 1.4.3 (Understanding 1.4.3)
                </a>
                <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://www.w3.org/WAI/WCAG21/quickref/#use-of-color"
                >
                    Use of Color 1.4.1 (Understanding 1.4.1)
                </a>
                <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://www.w3.org/WAI/WCAG21/quickref/#non-text-contrast"
                >
                ...
                <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://www.w3.org/WAI/WCAG21/quickref/#error-identification"
                >
                    Error Identification 3.3.1 (Understanding 3.3.1)
                </a>
                <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://www.w3.org/WAI/WCAG21/quickref/#labels-or-instructions"
                >
                    Labels or Instructions 3.3.2 (Understanding 3.3.2)
                </a>
                <a
                    target="_blank" rel="noopener noreferrer"
                    href="https://www.w3.org/WAI/WCAG21/quickref/#error-suggestion"
                >
                    Error Suggestion 3.3.3 (Understanding 3.3.3)
                </a>
                <p>
                    HIERARCHY
                </p>
                ...
                <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://www.w3.org/WAI/WCAG21/quickref/#consistent-navigation"
                >
                ...
                <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://www.w3.org/WAI/WCAG21/quickref/#multiple-ways"
                >
                ...
                <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://www.w3.org/WAI/test-evaluate/preliminary/#contrast"
                >
                ...
                <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://www.w3.org/WAI/tutorials/forms/labels/#visual-position-of-label-text"
                >
                ...
                <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://www.w3.org/TR/mobile-accessibility-mapping/#h-small-screen-size"
                >
                    Small Screen Size
                    </a>
                <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://www.w3.org/TR/mobile-accessibility-mapping/#mobile-accessibility-considerations-related-primarily-to-principle-3-understandable"
                >
                    Mobile considerations related to Understandability</a>
                <p>HIERARCHY</p>
                <a
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://medium.muz.li/gestalt-principles-in-ui-design-6b75a41e9965?gi=92604929b5a6"
                >
                ...
                <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://www.justinmind.com/blog/navigation-design-almost-everything-you-need-to-know/"
                >
                ...
                <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://www.w3.org/WAI/tips/designing/#use-headings-and-spacing-to-group-related-content"
                >
                ...
                <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://accessibility.digital.gov/visual-design/layout-and-hierarchy/"
                >
                ...
                <a
                    target="_blank"
                    rel="noopener noreferrer"
                    href="https://accessibility.psu.edu/fontsizehtml/"
                >
