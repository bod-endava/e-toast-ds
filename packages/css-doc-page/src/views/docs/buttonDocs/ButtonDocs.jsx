...
import ctaMark from '../../../assets/markdown/components/buttons/cta.md';
import ctaMarkIcon from '../../../assets/markdown/components/buttons/cta-icon.md';
import fillMark from '../../../assets/markdown/components/buttons/primary.md';
import fillMarkIcon from '../../../assets/markdown/components/buttons/primary-icon.md';
import textMark from '../../../assets/markdown/components/buttons/text.md';
import textMarkIcon from '../../../assets/markdown/components/buttons/text-icon.md';
import outlineMark from '../../../assets/markdown/components/buttons/outline.md';
import outlineMarkIcon from '../../../assets/markdown/components/buttons/outline-icon.md';
import iconMark from '../../../assets/markdown/components/buttons/icon.md';
